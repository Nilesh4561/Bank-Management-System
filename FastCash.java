...
public class FastCash extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
		try{        
            ...
            if(ae.getSource()==b1){
                    Conn c1 = new Conn();
                    ResultSet rs = c1.s.executeQuery(" select * from tblBank where pin = '"+a+"' "); 
                    if(rs.next()){
                        String pin = rs.getString("pin");
                        balance = rs.getDouble("balance");
                        balance-=100;
                        String q1= "insert into tblBank values('"+pin+"',null,100,'"+balance+"')";
                    ...
                    if(rs.next()){
                        ...
                        balance = rs.getDouble("balance");
                        balance-=500;
                        String q1= "insert into tblBank values('"+pin+"',null,500,'"+balance+"')";
                        c1.s.executeUpdate(q1);
                    }
                    ...
                    if(rs.next()){
                        ...
                        balance = rs.getDouble("balance");
                        balance-=1000;
                        String q1= "insert into tblBank values('"+pin+"',null,1000,'"+balance+"')";
                        c1.s.executeUpdate(q1);
                    }
                    ...
                    if(rs.next()){
                        ...
                        balance = rs.getDouble("balance");
                        balance-=2000;
                        String q1= "insert into tblBank values('"+pin+"',null,2000,'"+balance+"')";
                        c1.s.executeUpdate(q1);
                    }
                    ...
                    if(rs.next()){
                        ...
                        balance = rs.getDouble("balance");
                        balance-=5000;
                        String q1= "insert into tblBank values('"+pin+"',null,5000,'"+balance+"')";
                        c1.s.executeUpdate(q1);
                    }
                    ...
                    if(rs.next()){
                        ...
                        balance = rs.getDouble("balance");
                        balance-=10000;
                        String q1= "insert into tblBank values('"+pin+"',null,10000,'"+balance+"')";
                        c1.s.executeUpdate(q1);
                    }
