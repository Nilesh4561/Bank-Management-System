...
public class SignUp3 extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
        ...
        long first7 = (ran.nextLong() % 9000000000000000L) + 1000000000000000L;
        ...
        try {
        	if(ae.getSource()==b1){
                ...
                if(t1.getText().equals("")) {
                    ...
                    Conn c1 = new Conn();
                    String q1 = "insert into tblSignUp3 values('"+c+"', '"+a+"', '"+first8+"', '"+first4+"', '"+b+"')";  
                    String q2 = "insert into tblLogin values('"+first8+"','"+first4+"')";
